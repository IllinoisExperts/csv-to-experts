...
def get_author_data(publication):
    ...
    for author in author_list:
        these_authors.append({"last_name": get_author_last(author),
...
def access_internal_persons(ip_file: str) -> pd.DataFrame:
    ...
    """
    ip_file = "/Users/elizabethschwartz/Documents/assistantships/scp/pri_import/sara_pri_script/data/Pure persons - 92322.xls"
...
def get_publication_year(publication):
    return publication["publication year"]
...
def main():
    publications = load_zotero_csv("/Users/elizabethschwartz/Documents/assistantships/scp/pri_import/sara_pri_script/data/pri_2022_bookSection.csv")
    internal_people = access_internal_persons("/Users/elizabethschwartz/Documents/assistantships/scp/pri_import/sara_pri_script/data/Pure persons - 92322.xls")
...
def test_page_range():
    publications = load_zotero_csv("/Users/elizabethschwartz/Documents/assistantships/scp/pri_import/sara_pri_script/data/pri_2022_bookSection.csv")
    for publication in publications:
        print(get_pages_range(publication))
